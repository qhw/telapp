...
import com.cn.shopapp.adapter.AllSellListAdapter;
...
public class All_Sell extends Activity {

	private ListView listView = null;
	private Bundle bundle = null;
	private ProgressDialog mLoadingDialog = null;
	private ArrayList<BusinessInfo> listItem = new ArrayList<BusinessInfo>();
	private AllSellListAdapter listItemAdapter = null;
	...
	private void setUpViews(){
		...
		list_footer = (LinearLayout)LayoutInflater.from(All_Sell.this).inflate(R.layout.list_footer, null);
		...
		listItemAdapter = new AllSellListAdapter(All_Sell.this, item);
		...
		listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				intent.setClass(All_Sell.this, BusinessDetail.class);
	...
	private void getData() {
		...
		String url = Config.baseUrl + "telapp/business/getallsell.jsp";
		String allsellinfo = jsonData.getJson(url).trim();
		JSONArray array;
		try {
			array = new JSONArray(allsellinfo);
			currentSize += array.length();
			for (int i = 0; i < array.length(); i++) {
				JSONObject object = new JSONObject(array.getString(i));
				String imgUrl = Config.baseUrl + Config.workspace	+ object.getString("userimg");
