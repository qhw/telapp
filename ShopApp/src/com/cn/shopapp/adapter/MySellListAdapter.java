...
public class MySellListAdapter extends ArrayAdapter<BusinessInfo> {

	    private List<BusinessInfo> businessInfos = null;
	    private AsyncImageLoader asyncImageLoader = null;
	    private Context context = null;
	    public MySellListAdapter(Context context, List<BusinessInfo> businessInfos) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
				...
				convertView = LayoutInflater.from(context).inflate(R.layout.my_sell_item, null);		       
