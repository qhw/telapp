...
import com.cn.shopapp.adapter.AllBuyListAdapter;
...
public class All_Buy extends Activity {
	...
	private void setUpViews(){
		...
		list_footer = (LinearLayout)LayoutInflater.from(All_Buy.this).inflate(R.layout.list_footer, null);
		...
		listItemAdapter = new AllBuyListAdapter(All_Buy.this, item);
		...
		listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				intent.setClass(All_Buy.this, BusinessDetail.class);
	...
	private void getData() {
		...
		String url = Config.baseUrl + "telapp/business/getallbuy.jsp";
		String allbuyinfo = jsonData.getJson(url).trim();
		JSONArray array;
		try {
			array = new JSONArray(allbuyinfo);
